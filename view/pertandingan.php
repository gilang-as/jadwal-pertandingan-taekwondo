							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="course_detail">
									<div class="course_faculty">
										<img src="http://placehold.it/32X32" alt=""> <a href="instructor_dashboard.html">evans sinai</a>
									</div>
								</div>
							</div>
					...
					<div class="sidebar_wrapper">
						...
						<aside class="widget widget_categories">
							...
							<ul>
								...
								<li><a href="course_single.html"><i class="fa fa-chevron-right"></i> management</a></li>
